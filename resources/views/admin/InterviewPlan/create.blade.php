...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        ...
        <div class="account-settings-container layout-top-spacing">
            <form method="post" action="{{ route('plan-interview.store') }}" enctype="multipart/form-data" id="createPlanForm">
                @csrf
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="shared_Interviews" value="{{old('shared_Interviews')}}" id="shared_Interviews" class="form-control mb-4" placeholder="shared Interviews">
