...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        ...
        <div class="account-settings-container layout-top-spacing">
            <form method="post" action="{{ route('questions.store') }}" enctype="multipart/form-data" id="createPlanForm">
                @csrf
                                                            ...
                                                            <div class="row">                                                                
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="questions"  id="questions" class="form-control mb-4" rows="3">{{old('questions')}}</textarea>
                                                                        @error('questions')
