...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        ...
        <div class="account-settings-container layout-top-spacing">
            <form method="post" action="{{route('plan-management.update', $id)}}" enctype="multipart/form-data" id="createPlanForm">
                @csrf
                @method('PUT')
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="plan_name" value="{{$plan->name}}" id="plan_name" class="form-control" placeholder="Plan Name">
                                                                        @error('plan_name')
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="number_of_job_applications" value="{{$plan->number_of_job_applications}}" id="number_of_job_applications" class="form-control" placeholder="Number Of Job Applications">
