                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-2 col-lg-12 col-md-4">
                                                                    <div class="upload mt-4 pr-md-4">
                                                                        <input type="file" name="profile_image" id="input-file-max-fs" class="dropify" @if($User && $User->profile_image) data-default-file="{{url('/').'/'.$User->profile_image}}" @else data-default-file="{{url('admin/assets/img/200x200.jpg')}}" @endif data-max-file-size="2M" />
