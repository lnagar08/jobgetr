...
<div class="mail-messages-body-top" style="width: 640px;margin: 50px auto;">
  <div class="mail-messages-body" style="padding: 20px;background: #eaeaea;">
    ...
    <div class="mail-docu" style="padding: 28px 36px 36px 36px;border-radius: 2px;background: #002d6b;text-align: center;margin-bottom: 20px;">
      ...
      <p style="font-weight: 400;font-size: 16px;line-height: 24px;color: #fff;margin-bottom: 22px;margin-top: 0px;">Thank you for verification on our platform. To complete the email verification process, please click the following link to verification</p>
      <p style="font-weight: 400;font-size: 16px;line-height: 24px;color: #fff;margin-bottom: 22px;margin-top: 0px;">Link: <a href="{{$data['link']}}" style="word-break: break-all;">{{$data['link']}}</a></p>
    </div>
    <div class="namemail">
      <p style="font-size: 14px;margin: 0px 0px 17px 0px;color: #000;">This verification link is valid for a limited time. Do not share it with anyone. If you did not request this verification, please ignore this email.</p>
