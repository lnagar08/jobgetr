...
<div class="mail-messages-body-top" style="width: 640px;margin: 50px auto;">
  <div class="mail-messages-body" style="padding: 20px;background: #eaeaea;">
    ...
    <div class="mail-docu" style="padding: 28px 36px 36px 36px;border-radius: 2px;background: #002d6b;text-align: center;margin-bottom: 20px;">
      ...
      <h2 style="font-weight: 700;font-size: 20px;line-height: 24px;color: #fff;margin-bottom: 22px;margin-top: 0px;">Hello {{ucfirst($details['first_name'])}},</h2>
      <p style="font-weight: 400;font-size: 16px;line-height: 24px;color: #fff;margin-bottom: 22px;margin-top: 0px;">Your jobgetr login password is: <strong style="font-weight: 700;font-size: 20px;">{{$details['password']}}</strong></p>
    </div>
    <div class="namemail">
      <p style="font-size: 14px;margin: 0px 0px 17px 0px;color: #000;">For security, if you want to change your password <a href="{{$details['change_password']}}" style="color: #458dfc;margin: 0px 0px 10px 0px;">click here.</a></p>
