...
<body class="form">
    <div class="form-container">
        <div class="form-form loginform">
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">

                        <h1 class="">Log In to <span class="brand-name">Admin</span></h1>
                        ...
                        @endif
                        <form method="post" action="{{route('check-admin-login')}}" class="text-left">
                            @csrf
                            <div class="form">
                        ...
                        <!--<p class="terms-conditions">© 2021 All Rights Reserved. <a href="{{url('/')}}">jobgetr</a> is a product of Designreset. <a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>-->
